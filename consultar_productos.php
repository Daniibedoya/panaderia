        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="modificar_productos.php?codigo_producto=<?php echo $url; ?>"><img src="img/pencil-and-paper.png"></a>

                        <a href="consultar_productos.php?delete=<?php echo $row['codigo_producto'];?>"><img src="img/delete.png">
                        </a>
                    </td>
                </tr>
            <?php } ?>
