		...
		<table class="table table-sm">
			...
			<tbody>
                ...
                while ($row = mysql_fetch_array($pame)) {
                    ...
                    $url2=cadenas().encrypt($row['correo'],'URLCODIGO2');
            ?>
                <tr>
                    ...
                    <td>
                        <a href="modificar_usuarios.php?id_usuario=<?php echo $url; ?>"><img src="img/pencil-and-paper.png"></a>

                        <a href="consultar_usuario.php?delete=<?php echo $row['id_usuario'];?>"><img src="img/delete.png">
                        </a>

                        <a href="consultar_permisos.php?permisos=<?php echo $url2;?>"><img src="img/lupa.png">
                        </a>
                    </td>
                </tr>
            <?php } ?>
